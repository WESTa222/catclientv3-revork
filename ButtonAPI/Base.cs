...
internal static class Logs
{
    internal static void Log(string message, ConsoleColor color = ConsoleColor.White) =>
        ModMain.instance.Log.LogMessage(" [WorldAPI ML] " + message); //CLogs.Log(message, Color: color, Name: "WorldAPI");

    internal static void Error(Exception e, string message) => Error(message, e);

    internal static void Error(string message, Exception e = null) => ModMain.instance.Log.LogError(message + "\n" + e);
}
...
public class APIBase {
    ...
    public static bool IsReady() {
        ...
        if ((Button = QuickMenu?.transform.Find("CanvasGroup/Container/Window/QMParent/Body/Menu_Here/ScrollRect/Viewport/VerticalLayoutGroup/Buttons_WorldActions/Button_NewInstance")) == null) 
        ...
        if ((MenuPage = QuickMenu?.transform.Find("CanvasGroup/Container/Window/QMParent/Body/Menu_Camera")) == null)
        ...
        if ((ButtonGrp = QuickMenu?.transform.Find("CanvasGroup/Container/Window/QMParent/Body/Menu_Camera/Scrollrect/Viewport/VerticalLayoutGroup/Buttons")?.gameObject) == null)
            throw new NullReferenceException("ButtonGrp Is Null!");
        if ((ButtonGrpText = QuickMenu?.transform.Find("CanvasGroup/Container/Window/QMParent/Body/Menu_Camera/Scrollrect/Viewport/VerticalLayoutGroup/Header_H3")?.gameObject) == null)
            throw new NullReferenceException("ButtonGrpText Is Null!");
        if ((ColpButtonGrp = QuickMenu?.transform.Find("CanvasGroup/Container/Window/QMParent/Body/Menu_QM_GeneralSettings/Panel_QM_ScrollRect/Viewport/VerticalLayoutGroup/UIElements")?.gameObject) == null) 
            throw new NullReferenceException("ColpButtonGrp Is Null!");
        if ((Slider = QuickMenu?.transform.Find("CanvasGroup/Container/Window/QMParent/Body/Menu_QM_GeneralSettings/Panel_QM_ScrollRect/Viewport/VerticalLayoutGroup/DisplayAndVisualAdjustments/QM_Settings_Panel/VerticalLayoutGroup/ScreenBrightness")) == null)
            throw new NullReferenceException("Slider Is Null!");
